...
//  GMStepper
//
//  Created by Arunkumar on 1/6/18.
//  Copyright © 2018 Arunkumar. All rights reserved.
//
...
@IBDesignable public class GMStepper: UIControl {
    ...
    @objc public var buttonsFont = UIFont(name: "HelveticaNeue-Bold", size: 20.0)! {
        didSet {
            for button in [leftButton, rightButton] {
    ...
    @objc public var labelFont = UIFont(name: "HelveticaNeue-Bold", size: 18.0)! {
        didSet {
